...
const functions = {
    ...
    createUpdateTransaction: async (args)=>{
        let developerKey = snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .PrivateKey.fromBase58 */ ._q.fromBase58("EKFVjvGhKJCQTusjS78UYSffvReqrGkS9RsN5ukZUg5n3DNJAheJ");
    ...
    getTransactionJSON: async (args)=>{
        ...
        let developerKey = snarkyjs__WEBPACK_IMPORTED_MODULE_0__/* .PrivateKey.fromBase58 */ ._q.fromBase58("EKFVjvGhKJCQTusjS78UYSffvReqrGkS9RsN5ukZUg5n3DNJAheJ");
        let sentTx = await state.transaction.sign([
            developerKey
        ]).send();
        let msg = "";
        if (sentTx.hash() !== undefined) {
            msg = "https://berkeley.minaexplorer.com/transaction/".concat(sentTx.hash());
            console.log(msg);
        }
...
/******/ 			return "static/chunks/" + (chunkId === 829 ? "cc8f0cfa" : chunkId) + "." + {"189":"1817c0373708f86a","829":"0d2d855e0fcb6152"}[chunkId] + ".js";
/******/ 		};
/******/ 	}();
/******/ 	
